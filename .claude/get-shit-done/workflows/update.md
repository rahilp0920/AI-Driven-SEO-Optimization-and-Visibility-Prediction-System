...
global: `/Users/rahilpatel/Documents/AI-Driven-SEO-Optimization-and-Visibility-Prediction-System/.claude/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, `~/.config/kilo/`, or `~/.codex/`
