...
```bash
INIT=$(node "/Users/rahilpatel/Documents/AI-Driven-SEO-Optimization-and-Visibility-Prediction-System/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/rahilpatel/Documents/AI-Driven-SEO-Optimization-and-Visibility-Prediction-System/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/rahilpatel/Documents/AI-Driven-SEO-Optimization-and-Visibility-Prediction-System/.claude/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
